...
<template>
    <el-dialog title="修改角色" :modal=true :modal-append-to-body="false" :visible="show" top="15%" class="bindDialog" :before-close="handleClose">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px">
        <el-form-item  label="角色ID" prop="id">
          <el-col :span="12">
            <el-input v-model="id" :disabled="true" placeholder="角色ID"></el-input>
          </el-col>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      roleDesc: this.ruleForm.roleDesc,id: this.id});
